...
public class EnquiryServiceImpl implements EnquiryService {
	...
	{
		SimpleMailMessage message = new SimpleMailMessage();			//For Sending an Email About Cibil Score
		...
		if(cibilChecked>=750) 
		{
			...
			message.setSubject("Regarding Car Loan For Documentation of Applicant Name :"+enq.getEnquiryFirstName()+""+enq.getEnquiryLastName());
